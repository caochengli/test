...
document.getElementById('bgs').appendChild(stats.domElement);
/*
 * Shader Start
 */
...
var renderer = new PIXI.WebGLRenderer(1900, 640);
document.getElementById('bgs').appendChild(renderer.view);
